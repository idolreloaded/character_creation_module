"""This module creates a character and shows its perks in training."""
...
def attack(char_name: str, char_class: str) -> str:
    """Return an attack interactive string depending on class."""
...
def defence(char_name: str, char_class: str) -> str:
    """Return an defence interactive string depending on class."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Return a special attack string depending on class."""
    if char_class == 'warrior':
